...
export default function SidePanelWidget() {
  ...
  const isInReport = reportContent.some(
    (item) => item.title === sidePanelContent.title
  );
  ...
  return (
    ...
    >
      <Flex
        ...
        gap="2"
        alignItems="center"
        bg={isInReport ? "blue.subtle" : "bg.muted"}
      ...
      >
        ...
        <Heading size="sm" m="0" as="h4">
          {sidePanelContent.title}
        </Heading>
        {isInReport ? (
          <Button
            size="xs"
            ...
            variant="outline"
            onClick={() => deleteFromReport(sidePanelContent.title)}
          >
            Remove From Report
          </Button>
        ) : (
          <Button
            ...
            textTransform="uppercase"
            variant="solid"
            onClick={() => addToReport(sidePanelContent)}
          >
            Add To Report
          </Button>
        )}
